...
def upgrade() -> None:
    ...
    op.execute("INSERT INTO users (id, username, email, password, is_oauth_user) VALUES (1, 'admin', 'admin@example.com', '$2b$12$LQv3c1yqBWVHxkd0LHAkCOYz6TtxMQJqhN8/LewPaLZQcYUoEL3fG', false)")
